...
-- Add tab open and close keymap for barbar tabline
...
vim.keymap.set('n', '<A-S-,>', '<Cmd>BufferMovePrevious<CR>', { desc = 'Reorder to previous buffer', noremap = true, silent = true })
vim.keymap.set('n', '<A-S-.>', '<Cmd>BufferMoveNext<CR>', { desc = 'Reorder to next buffer', noremap = true, silent = true })
